...
if(ISSOFAPYTHON_USE_LOCAL_ENV)
    ...
    if(NOT EMBEDDED_PYTHON)
        ...
        execute_process(
            COMMAND
            ${PYTHON_EXECUTABLE} -m ${VIRTUALENV_PACKAGE} "${ISSOFAPYTHON_LOCAL_ENV_DIR}"
    ...
    if(NOT EMBEDDED_PYTHON)
        ...
        install(CODE "
            if (EXISTS ${ISSOFAPYTHON_LOCAL_ENV_INSTALL_DIR}/${ISSOFAPYTHON_EXECUTABLE_RELPATH})
                ...
                execute_process(
                    COMMAND
                    ${PYTHON_EXECUTABLE} -m ${VIRTUALENV_PACKAGE} --always-copy \"${ISSOFAPYTHON_LOCAL_ENV_INSTALL_DIR}\"
